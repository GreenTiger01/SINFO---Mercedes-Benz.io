...
var prices = [39.99,154.10,9.90,13.20,14.10,350.99,77.77,14.33];
var total = 0.00;
var slide = 1;
...
function totalPrice(){
  total = quantities[0]*prices[0] + quantities[1]*prices[1] +
          quantities[2]*prices[2] + quantities[3]*prices[3] +
          quantities[4]*prices[4] + quantities[5]*prices[5] +
          quantities[6]*prices[6] + quantities[7]*prices[7];
